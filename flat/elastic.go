...
func (ss ElasticStorage) Search(qp QueryParam) ([]Product, int64, error) {
...
func (ss ElasticStorage) InitFixtures() error {
	...
	prod1 := Product{Title: "Adidas sneakers", Brand: "Adidas", Price: 59.99, Stock: 5}
	...
	prod2 := Product{Title: "Nike sneakers", Brand: "Nike", Price: 79.99, Stock: 5}
	if _, err = ss.ElasticClient.Index().
		Index(productIndexKey).
		Type("doc").
		Id("2").
	...
	prod3 := Product{Title: "Puma sneakers", Brand: "Puma", Price: 89.99, Stock: 5}
	if _, err = ss.ElasticClient.Index().
		Index(productIndexKey).
		Type("doc").
		Id("3").
	...
	prod4 := Product{Title: "Puma tshirt", Brand: "Puma", Price: 19.99, Stock: 5}
	if _, err = ss.ElasticClient.Index().
		Index(productIndexKey).
		Type("doc").
		Id("4").
	...
	prod5 := Product{Title: "Nike tshirt", Brand: "Nike", Price: 29.99, Stock: 5}
	if _, err = ss.ElasticClient.Index().
		Index(productIndexKey).
		Type("doc").
		Id("5").
	...
	prod6 := Product{Title: "Asics tshirt", Brand: "Asics", Price: 9.99, Stock: 5}
	if _, err = ss.ElasticClient.Index().
		Index(productIndexKey).
		Type("doc").
		Id("6").
